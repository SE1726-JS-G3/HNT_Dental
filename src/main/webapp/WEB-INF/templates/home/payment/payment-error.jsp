...
<div class="back-to-home rounded d-none d-sm-block">
  <a href="${pageContext.request.contextPath}/home" class="btn btn-icon btn-primary"><i data-feather="home" class="icons"></i></a>
</div>
  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-7 col-md-10 text-center">
        <br><br><br><br><br>
        <img src="${pageContext.request.contextPath}/static/images/payment/payment-error.gif" class="img-fluid" alt="">
        <br><br><br><br>
        <h3 class="mb-4">Thanh toán thất bại.</h3>
