...
<%--                <img src="https://shreethemes.in/doctris/layouts/assets/images/blog/single.jpg"--%>
                        ...
                        <div class="card blog blog-primary border-0 shadow rounded overflow-hidden m-1">
                            ...
                            <div class="card-body p-4">
                                <ul class="list-unstyled mb-2">
                                    <li class="list-inline-item text-muted small me-3"><i class="uil uil-calendar-alt text-dark h6 me-1"></i>27th July, 2024</li>
