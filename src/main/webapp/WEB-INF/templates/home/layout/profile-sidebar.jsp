...
<div class="col-xl-3 col-lg-3 col-md-4 col-12">
    <div class="rounded shadow overflow-hidden sticky-bar">
        ...
        <ul class="list-unstyled sidebar-nav mb-0">
            ...
            <li class="navbar-item"><a href=" /auth/service-history" class="navbar-link"><i class="ri-airplay-line align-middle navbar-icon"></i> Lịch sử dịch vụ</a></li>
            <li class="navbar-item"><a href="/auth/my-appointment" class="navbar-link"><i class="ri-airplay-line align-middle navbar-icon"></i> Lịch sử lịch hẹn</a></li>
        </ul>
    </div>
</div>